...
The tui-toast capability governs transient toast notifications displayed in the TUI dashboard. Toasts auto-dismiss after a fixed duration without requiring user interaction.
