...
Defines the Sessions tab in the dashboard TUI: tab-toggle entry, two-level drill-in table (Level-1 projects, Level-2 individual sessions), sort/filter/pin keybindings, and interaction with the Notifications view for pinned sessions.
