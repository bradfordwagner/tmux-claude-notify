...
Defines how the dashboard opens or resumes Claude sessions from the Sessions view. Covers keybindings for opening new sessions in a project (Level-1) and for resuming or focusing existing sessions (Level-2), as well as outer-session targeting for split-window commands.
